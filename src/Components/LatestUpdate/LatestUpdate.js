                ...
                <div className="kdr-data-section">
                    <Wrapper flexCenter='flex'>
                        <div className="kdr-data">
                            ...
                            <Card type='death' icon={DeathIcon} name = 'Deaths' data={caseData.today_death}/>
                            <Card type='recovered' icon={RecoverdIcon} name = 'Recovered' data={caseData.today_recovered}/>
