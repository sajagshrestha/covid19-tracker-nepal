...
const DistrictKDR = ({data}) =>{
    ...
    },[data,district,districtNewCases,defaultDistrictData.Kathmandu,defaultDistrictData.Bhaktapur,defaultDistrictData.Lalitpur])
    return (
        <DistrictKDRWrapper>
            <div className="title">
                <div className="main-title">By District</div>
                <SelectDistrict className='updated-at' setDistrict={setDistrict}/>
            </div> 
        {district=== '' ? 
            <div className="kdr-data-section">
                
                    <div className="kdr-data">
                        <DistrictCard name='Bhaktapur' data ={defaultDistrictData.Bhaktapur}/>
                        <DistrictCard justify="center" name='Kathmandu' data ={defaultDistrictData.Kathmandu} />
                        <DistrictCard justify="end" name='Lalitpur' data ={defaultDistrictData.Lalitpur}/>
                    </div>  
         
            </div>       
        :
        <div className="kdr-data-section-single">
             <DistrictCard type='singleDistrict' name={district} data={districtNewCases}/>
        </div>
